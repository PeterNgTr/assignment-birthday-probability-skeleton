...
public class Logic 
    ...
    */
    ...
    public double calculate(int groupSize, int simulationCount) {
        // TODO -- add your code here
        int numberOfMatches = 0;

        for (int i = 0; i < simulationCount; ++i) {
            if (isMatchInTrial(groupSize)) {
                numberOfMatches++;
            }
        }
        double percent = (100.00 * numberOfMatches / simulationCount);
        return percent;
    }

    // TODO - add your code here
    private static boolean isMatchInTrial(int groupSize) {
        Set<Integer> birthdays = new HashSet<>();
        for (int i = 0; i < groupSize; ++i) {
            birthdays.add(random.nextInt(daysInYear));
        }
        return birthdays.size() != groupSize;
    }
